...
import ru.amai.study.coursera.kotlin.week4.RationalTest.ComparisonOperation.*

internal class RationalTest {
    private fun testNormalizedForm(rational: String, normalizedForm: String) {
        assertThat(rational.toRational().toString())
            .describedAs("normalized form for $rational")
            .isEqualTo(normalizedForm)
    }
    ...
    private fun testArithmeticOperation(first: String, operationRepresentation: String, second: String,
        ...
        assertThat(first.toRational().operation(second.toRational()).toString())
            .describedAs("""result for $first $operationRepresentation $second""")
